...
public class TestOnly {
    ...
    private static UserVertex[] testList;
    ...
    public static void main(String[] args) throws IOException {
        ...
        usersGraph.createGraph1(testList,testarray);
        usersGraph.printGraph();
        usersGraph.createGraph2(testList,testarray);
        usersGraph.printGraph();
        for(int i = 0; i < testList.length; i++) {
            usersGraph.countFollowers(testList[i]);
        }
